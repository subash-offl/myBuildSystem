...
<Project Type="Project" LVVersion="23008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="ExcludedDependencies" Type="Folder">
			<Item Name="CoreOperation.lvclass" Type="LVClass" URL="/C/Program Files (x86)/National Instruments/Shared/LabVIEW CLI/Operations/CoreOperation/CoreOperation.lvclass"/>
			<Item Name="GetOperationError.vi" Type="VI" URL="/C/Program Files (x86)/National Instruments/Shared/LabVIEW CLI/Operations/Utilities/GetOperationError.vi"/>
			<Item Name="GetOperationOutput.vi" Type="VI" URL="/C/Program Files (x86)/National Instruments/Shared/LabVIEW CLI/Operations/Utilities/GetOperationOutput.vi"/>
			<Item Name="Logger.lvclass" Type="LVClass" URL="/C/Program Files (x86)/National Instruments/Shared/LabVIEW CLI/Operations/Utilities/Logger/Logger.lvclass"/>
			<Item Name="OperationErrorType.ctl" Type="VI" URL="/C/Program Files (x86)/National Instruments/Shared/LabVIEW CLI/Operations/Utilities/OperationErrorType.ctl"/>
			<Item Name="Verbosity.ctl" Type="VI" URL="/C/Program Files (x86)/National Instruments/Shared/LabVIEW CLI/Operations/Utilities/Verbosity.ctl"/>
		</Item>
